...
class Rent(models.Model):
    ...
    base_rate_bps = models.DecimalField(decimal_places=3, max_digits=16)
    ...
    fixed_fee_added_amount = models.DecimalField(decimal_places=2, max_digits=16)
    variable_fee_added_rate_bps = models.DecimalField(decimal_places=3, max_digits=16)
    variable_fee_added_amount = models.DecimalField(decimal_places=2, max_digits=16)
    fixed_fee_deducted_currency = models.ForeignKey(Currency, related_name="rent_fixed_fee_deducted_currency", default="GBP")
    fixed_fee_deducted_amount = models.DecimalField(decimal_places=2, max_digits=16)
    variable_fee_deducted_rate_bps = models.DecimalField(decimal_places=3, max_digits=16)
    variable_fee_deducted_amount = models.DecimalField(decimal_places=2, max_digits=16)
    TYPE_CHOICES = (
        ('coupon', 'Coupon'),
        ('principal', 'Principal'),
    )
